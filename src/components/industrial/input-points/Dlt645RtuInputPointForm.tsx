...
interface Dlt645RtuInputPointFormProps {
  address: string;
  dataType: string;
  scanRate: number;
...
const Dlt645RtuInputPointForm: React.FC<Dlt645RtuInputPointFormProps> = ({
  address,
  dataType,
  scanRate,
  onAddressChange,
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      <div>
        ...
        <Input
          type="number"
          value={scanRate}
          onChange={(e) => onScanRateChange(parseInt(e.target.value) || 60000)}
          placeholder="60000"
        />
      </div>
    </div>
...
export default Dlt645RtuInputPointForm;